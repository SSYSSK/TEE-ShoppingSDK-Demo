...
{
    [NetworkManager.shareNetworkManager setContentType:@"application/json"];
        ...
        failure:(void (^) (NSError *error, ParamtersJudgeCode  judgeCode))failure
{
    ...
    [NetworkManager.shareNetworkManager setContentType:type];
...
-(void)setContentType:(NSString *)type {
    ...
    [_sessionManager.requestSerializer setValue:type forHTTPHeaderField:@"Content-Type"];
}
